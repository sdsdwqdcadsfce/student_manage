<template>
    <div>
        ...
        <el-breadcrumb separator=">">
            ...
            <el-breadcrumb-item>学生课程考试管理</el-breadcrumb-item>
            <el-breadcrumb-item>学生课程考试列表</el-breadcrumb-item>
        </el-breadcrumb>
        <!--        卡片视图区-->
        <el-card>
            <!--            栅格布局-->
        ...
        <el-dialog
            ...
            <el-form :model="RegistForm"  ref="registFormRef" label-width="100px">
                ...
                <el-form-item label="考试类别" prop="testType">
                    <el-input v-model="RegistForm.testType"></el-input>
                </el-form-item>
                <el-form-item label="考试日期" prop="testDate">
                    <el-input v-model="RegistForm.testDate"></el-input>
                </el-form-item>
                <el-form-item label="考试安排" prop="testAnpai">
                    <el-input v-model="RegistForm.testAnpai"></el-input>
                </el-form-item>
                <el-form-item label="考试地点" prop="testDidian">
                    <el-input v-model="RegistForm.testDidian"></el-input>
                </el-form-item>
                <el-form-item label="考场座位号" prop="testZuoweihao">
                    <el-input v-model="RegistForm.testZuoweihao"></el-input>
                </el-form-item>
                <el-form-item label="考试情况" prop="testQingkuang">
                    <el-input v-model="RegistForm.testQingkuang"></el-input>
                </el-form-item>
                <el-form-item label="其他说明" prop="testOther">
                    <el-input v-model="RegistForm.testOther"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog
            ...
            <el-form :model="updateForm"  ref="updateFormRef" label-width="100px">
                ...
                <el-form-item label="考试类别" prop="testType">
                    <el-input v-model="updateForm.testType" ></el-input>
                </el-form-item>
                <el-form-item label="考试日期" prop="testDate">
                    <el-input v-model="updateForm.testDate"></el-input>
                </el-form-item>
                <el-form-item label="考试安排" prop="testAnpai">
                    <el-input v-model="updateForm.testAnpai"></el-input>
                </el-form-item>
                <el-form-item label="考试地点" prop="testDidian">
                    <el-input v-model="updateForm.testDidian"></el-input>
                </el-form-item>
                <el-form-item label="考场座位号" prop="testZuoweihao">
                    <el-input v-model="updateForm.testZuoweihao"></el-input>
                </el-form-item>
                <el-form-item label="考试情况" prop="testQingkuang">
                    <el-input v-model="updateForm.testQingkuang"></el-input>
                </el-form-item>
                <el-form-item label="其他说明" prop="testOther">
                    <el-input v-model="updateForm.testOther"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
